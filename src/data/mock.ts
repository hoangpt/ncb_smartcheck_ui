...
export const MOCK_FILES: FileRecord[] = [
    ...
    // --- 17/12/2025 (4 files) ---
    {
        ...
        process_progress: 100,
        page_map: [
            { range: "1-2", deal_id: "FC208TQD...011", type: "Deal", status: "valid" },
            { range: "3-15", deal_id: "FC208TQD...012", type: "Deal", status: "review" }
        ]
    },
    {
        id: "FILE_20251217_02",
        ...
        process_progress: 100,
        page_map: [
            { range: "1-22", deal_id: "BATCH_VQ_001", type: "Batch", status: "valid" }
        ]
    },
    {
        id: "FILE_20251217_03",
    ...
    },
    {
        ...
        process_progress: 100,
        page_map: [
            { range: "1-10", deal_id: "FC208TQD...016", type: "Deal", status: "valid" }
        ]
    },
    ...
    // --- 18/12/2025 (4 files) ---
    {
        ...
        process_progress: 100,
        page_map: [
            { range: "1-3", deal_id: "FC208TQD...020", type: "Deal", status: "valid" },
            { range: "4-6", deal_id: "FC208TQD...021", type: "Deal", status: "valid" },
            { range: "7-9", deal_id: "FC208TQD...022", type: "Deal", status: "valid" },
            { range: "10-12", deal_id: "FC208TQD...023", type: "Deal", status: "valid" },
            { range: "13-15", deal_id: "FC208TQD...024", type: "Deal", status: "valid" },
            { range: "16-18", deal_id: "FC208TQD...025", type: "Deal", status: "valid" },
            { range: "19-21", deal_id: "FC208TQD...026", type: "Deal", status: "review" },
            { range: "22-24", deal_id: "FC208TQD...027", type: "Deal", status: "valid" },
            { range: "25-27", deal_id: "FC208TQD...028", type: "Deal", status: "valid" },
            { range: "28-30", deal_id: "FC208TQD...029", type: "Deal", status: "valid" }
        ]
    },
    {
        id: "FILE_20251218_02",
        ...
        process_progress: 100,
        page_map: [
            { range: "1-50", deal_id: "BATCH_KQ_01", type: "Batch", status: "valid" }
        ]
    },
    {
        id: "FILE_20251218_03",
        ...
        process_progress: 100,
        page_map: [
            { range: "1-45", deal_id: "BATCH_KQ_02", type: "Batch", status: "valid" }
        ]
    },
    {
        id: "FILE_20251218_04",
        ...
        process_progress: 100,
        page_map: [
            { range: "1-3", deal_id: "FC208TQD...030", type: "Deal", status: "valid" },
            { range: "4-6", deal_id: "FC208TQD...031", type: "Deal", status: "valid" },
            { range: "7-9", deal_id: "FC208TQD...032", type: "Deal", status: "valid" },
            { range: "10-12", deal_id: "FC208TQD...033", type: "Deal", status: "valid" }
        ]
    },
    ...
    // --- 19/12/2025 (3 files) ---
    {
        ...
        process_progress: 100,
        page_map: [
            { range: "1-3", deal_id: "FC208TQD...040", type: "Deal", status: "valid" },
            { range: "4-6", deal_id: "FC208TQD...041", type: "Deal", status: "valid" },
            { range: "7-9", deal_id: "FC208TQD...042", type: "Deal", status: "valid" },
            { range: "10-12", deal_id: "FC208TQD...043", type: "Deal", status: "valid" },
            { range: "13-18", deal_id: "FC208TQD...044", type: "Deal", status: "review" }
        ]
    },
    {
        id: "FILE_20251219_02",
        ...
        process_progress: 100,
        page_map: [
            { range: "1-22", deal_id: "BATCH_TX_02", type: "Batch", status: "valid" }
        ]
    },
    {
        id: "FILE_20251219_03",
        ...
        process_progress: 100,
        page_map: [
            { range: "1-4", deal_id: "FC208TQD...045", type: "Deal", status: "valid" }
        ]
    },
    ...
    // --- 21/12/2025 (4 files) ---
    {
        ...
        process_progress: 100,
        page_map: [
            { range: "1-3", deal_id: "FC208TQD...050", type: "Deal", status: "valid" },
            { range: "4-6", deal_id: "FC208TQD...051", type: "Deal", status: "valid" },
            { range: "7-9", deal_id: "FC208TQD...052", type: "Deal", status: "valid" },
            { range: "10-12", deal_id: "FC208TQD...053", type: "Deal", status: "valid" },
            { range: "13-15", deal_id: "FC208TQD...054", type: "Deal", status: "valid" },
            { range: "16-18", deal_id: "FC208TQD...055", type: "Deal", status: "valid" },
            { range: "19-22", deal_id: "FC208TQD...056", type: "Deal", status: "valid" }
        ]
    },
    {
        id: "FILE_20251221_02",
        ...
        process_progress: 100,
        page_map: [
            { range: "1-3", deal_id: "FC208TQD...057", type: "Deal", status: "valid" },
            { range: "4-6", deal_id: "FC208TQD...058", type: "Deal", status: "valid" },
            { range: "7-9", deal_id: "FC208TQD...059", type: "Deal", status: "valid" },
            { range: "10-12", deal_id: "FC208TQD...060", type: "Deal", status: "valid" },
            { range: "13-18", deal_id: "FC208TQD...061", type: "Deal", status: "valid" }
        ]
    },
    {
        id: "FILE_20251221_03",
        ...
        process_progress: 100,
        page_map: [
            { range: "1-35", deal_id: "BATCH_H_01", type: "Batch", status: "valid" }
        ]
    },
    {
        id: "FILE_20251221_04",
        ...
        process_progress: 100,
        page_map: [
            { range: "1-4", deal_id: "FC208TQD...062", type: "Deal", status: "valid" },
            { range: "5-8", deal_id: "FC208TQD...063", type: "Deal", status: "valid" },
            { range: "9-12", deal_id: "FC208TQD...064", type: "Deal", status: "valid" }
        ]
    },
    ...
    // --- 22/12/2025 (5 files) ---
    {
        ...
        process_progress: 100,
        page_map: [
            { range: "1-50", deal_id: "MULTI_DEALS", type: "Batch", status: "valid" }
        ]
    },
    {
        id: "FILE_20251222_02",
        ...
        process_progress: 100,
        page_map: [
            { range: "1-55", deal_id: "MULTI_DEALS_2", type: "Batch", status: "valid" }
        ]
    },
    {
        id: "FILE_20251222_03",
        ...
        page_map: [
            ...
            { range: "3-4", deal_id: "FC208TQD...070", type: "Deal", status: "valid" },
            { range: "5-6", deal_id: "FC208TQD...071", type: "Deal", status: "valid" },
            { range: "7-8", deal_id: "FC208TQD...072", type: "Deal", status: "valid" },
            { range: "9-10", deal_id: "FC208TQD...073", type: "Deal", status: "valid" },
            { range: "11-12", deal_id: "FC208TQD...074", type: "Deal", status: "valid" },
            { range: "13-14", deal_id: "FC208TQD...075", type: "Deal", status: "valid" },
            { range: "15-16", deal_id: "FC208TQD...076", type: "Deal", status: "valid" },
            { range: "17-18", deal_id: "FC208TQD...077", type: "Deal", status: "valid" },
    ...
    },
    {
        ...
        process_progress: 100,
        page_map: [
            { range: "1-25", deal_id: "BATCH_MD_2", type: "Batch", status: "valid" }
        ]
    },
    {
        id: "FILE_20251222_05",
...
export const MOCK_DEALS: Deal[] = [
    ...
    { id: "FC208TQD...030", source_file: "18.12.2025 GDV_QUAY3.pdf", type: "Tiếp quỹ", user: "GDV_QUAY3", customer: "KH_LE_01", amount_system: 100000000, amount_extract: 100000000, currency: "VND", pages: "1-3", status: "matched", score: 100, timestamp: "18/12/2025 15:45", signatures: { teller: { status: "valid", name: "Nguyễn Thị Lan" }, supervisor: { status: "valid", name: "Lê Thị Bích" } } },
    { id: "FC208TQD...031", source_file: "18.12.2025 GDV_QUAY3.pdf", type: "Tiếp quỹ", user: "GDV_QUAY3", customer: "KH_LE_02", amount_system: 200000000, amount_extract: 200000000, currency: "VND", pages: "4-6", status: "matched", score: 100, timestamp: "18/12/2025 15:50", signatures: { teller: { status: "valid", name: "Nguyễn Thị Lan" }, supervisor: { status: "valid", name: "Lê Thị Bích" } } },
    { id: "FC208TQD...032", source_file: "18.12.2025 GDV_QUAY3.pdf", type: "Tiếp quỹ", user: "GDV_QUAY3", customer: "KH_LE_03", amount_system: 300000000, amount_extract: 300000000, currency: "VND", pages: "7-9", status: "matched", score: 100, timestamp: "18/12/2025 15:55", signatures: { teller: { status: "valid", name: "Nguyễn Thị Lan" }, supervisor: { status: "valid", name: "Lê Thị Bích" } } },
    { id: "FC208TQD...033", source_file: "18.12.2025 GDV_QUAY3.pdf", type: "Tiếp quỹ", user: "GDV_QUAY3", customer: "KH_LE_04", amount_system: 400000000, amount_extract: 400000000, currency: "VND", pages: "10-12", status: "matched", score: 100, timestamp: "18/12/2025 16:00", signatures: { teller: { status: "valid", name: "Nguyễn Thị Lan" }, supervisor: { status: "valid", name: "Lê Thị Bích" } } },

    // --- 19/12 Deals ---
    { id: "FC208TQD...040", source_file: "19.12.2025 CN_THANHXUAN_SANG.pdf", type: "Giao dịch", user: "CN_THANHXUAN", customer: "CTY ABC", amount_system: 550000000, amount_extract: 550000000, currency: "VND", pages: "1-3", status: "matched", score: 100, timestamp: "19/12/2025 08:30", signatures: { teller: { status: "valid", name: "Nguyễn Minh Tuấn" }, supervisor: { status: "valid", name: "Trần Thu Hà" } } },
    { id: "FC208TQD...044", source_file: "19.12.2025 CN_THANHXUAN_SANG.pdf", type: "Giao dịch", user: "CN_THANHXUAN", customer: "CTY XYZ", amount_system: 800000000, amount_extract: 800000000, currency: "VND", pages: "13-18", status: "review", score: 90, timestamp: "19/12/2025 09:00", signatures: { teller: { status: "valid", name: "Nguyễn Minh Tuấn" }, supervisor: { status: "review", name: "Trần Thu Hà" } } },
    { id: "BATCH_TX_02", source_file: "19.12.2025 CN_THANHXUAN_CHIEU.pdf", type: "Cuối ngày", user: "CN_THANHXUAN", customer: "NOI_BO", amount_system: 1500000000, amount_extract: 1500000000, currency: "VND", pages: "1-22", status: "matched", score: 100, timestamp: "19/12/2025 14:00", signatures: { teller: { status: "valid", name: "Nguyễn Minh Tuấn" }, supervisor: { status: "valid", name: "Trần Thu Hà" } } },

    // --- 21/12 Deals ---
    { id: "FC208TQD...050", source_file: "21.12.2025 GDV_LANPT_CA1.pdf", type: "Tiếp quỹ", user: "GDV_LANPT", customer: "KH_A", amount_system: 110000000, amount_extract: 110000000, currency: "VND", pages: "1-3", status: "matched", score: 100, timestamp: "21/12/2025 08:15", signatures: { teller: { status: "valid", name: "Phan Thị Lan" }, supervisor: { status: "valid", name: "Đỗ Văn Hùng" } } },
    { id: "FC208TQD...056", source_file: "21.12.2025 GDV_LANPT_CA1.pdf", type: "Tiếp quỹ", user: "GDV_LANPT", customer: "KH_G", amount_system: 770000000, amount_extract: 770000000, currency: "VND", pages: "19-22", status: "matched", score: 100, timestamp: "21/12/2025 08:45", signatures: { teller: { status: "valid", name: "Phan Thị Lan" }, supervisor: { status: "valid", name: "Đỗ Văn Hùng" } } },
    { id: "BATCH_H_01", source_file: "21.12.2025 GDV_HUNGNV.pdf", type: "Batch", user: "GDV_HUNGNV", customer: "NOI_BO", amount_system: 3500000000, amount_extract: 3500000000, currency: "VND", pages: "1-35", status: "matched", score: 100, timestamp: "21/12/2025 09:00", signatures: { teller: { status: "valid", name: "Nguyễn Văn Hùng" }, supervisor: { status: "valid", name: "Đỗ Văn Hùng" } } },

    // --- 22/12 Deals ---
    { id: "MULTI_DEALS", source_file: "22.12.2025 KHO_BAC_DAU_NGAY.pdf", type: "Batch", user: "KHO_BAC", customer: "NOI_BO", amount_system: 10000000000, amount_extract: 10000000000, currency: "VND", pages: "1-50", status: "matched", score: 100, timestamp: "22/12/2025 08:00", signatures: { teller: { status: "valid", name: "Đỗ Văn Hùng" }, supervisor: { status: "valid", name: "Admin" } } },
    { id: "MULTI_DEALS_2", source_file: "22.12.2025 KHO_BAC_CUOI_NGAY.pdf", type: "Batch", user: "KHO_BAC", customer: "NOI_BO", amount_system: 12000000000, amount_extract: 12000000000, currency: "VND", pages: "1-55", status: "matched", score: 100, timestamp: "22/12/2025 16:30", signatures: { teller: { status: "valid", name: "Đỗ Văn Hùng" }, supervisor: { status: "valid", name: "Admin" } } },
    { id: "BATCH_MD_2", source_file: "22.12.2025 CN_MY_DINH_2.pdf", type: "Batch", user: "CN_MY_DINH", customer: "NOI_BO", amount_system: 2200000000, amount_extract: 2200000000, currency: "VND", pages: "1-25", status: "matched", score: 100, timestamp: "22/12/2025 14:15", signatures: { teller: { status: "valid", name: "Nguyễn Thịnh" }, supervisor: { status: "valid", name: "Trần Thu Hà" } } }
];
